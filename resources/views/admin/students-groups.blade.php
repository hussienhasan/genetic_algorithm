...
<head>
    ...
    <title> أسم الموقع - مجموعات الطلاب</title>
...
<li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">مجموعات الطلاب </h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-lg btn-primary shadow-sm"
                            data-toggle="modal" data-target="#addModal"><i
                                class="fas fa-download fa-sm text-white-50"></i>اضافة مجموعة جديدة</a>
    ...
    <!-- Add students group Modal-->
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold"> أضف مجموعة طلاب</h4>
                ...
                <div class="modal-body mx-3">
                    <div class="md-form mb-1">
                        ...
                        <input type="number" min="1" max="5" id="stgYear" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="orangeForm-name">السنة</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-user prefix grey-text"></i>
                        <select id="stgDepartment" class="form-control validate">
                        ...
                        <label data-error="wrong" data-success="right" for="orangeForm-name">القسم</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-envelope prefix grey-text"></i>
                        <input type="number" min="0"  id="stgDivision" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="orangeForm-email">الشعبة</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-envelope prefix grey-text"></i>
                        <input type="number" min="0" id="stgCategory" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="orangeForm-email">الفئة</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-envelope prefix grey-text"></i>
                        <input type="number" min="1"  id="stgSize" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="orangeForm-email">العدد</label>
                    </div>


                </div>
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn btn-deep-orange" id="addingSTG">إضافة</button>
                </div>
            </div>
        </div>
    </div>
