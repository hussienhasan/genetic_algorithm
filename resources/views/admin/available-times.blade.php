...
<head>
    ...
    <title>أسم الموقع - الأوقات المتاحة</title>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">أضف وقت متاح</h4>
                ...
                <div class="modal-body mx-3">
                    <div class="md-form mb-1">
                        ...
                        <label data-error="wrong" data-success="right" for="orangeForm-name">اليوم</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-user prefix grey-text"></i>
                        <input type="text" placeholder="ex: 08:00" id="startTime">
                        <label data-error="wrong" data-success="right" for="orangeForm-name">وقت البداية</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-user prefix grey-text"></i>
                        <input type="text" placeholder="ex: 10:00" id="endTime">
                        <label data-error="wrong" data-success="right" for="orangeForm-name">وقت النهاية</label>
                    </div>

                </div>
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn btn-deep-orange" id="addingtime">إضافة</button>
                </div>
            </div>
        </div>
    </div>
