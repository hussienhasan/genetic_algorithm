...
<head>
    ...
    <title>أسم الموقع - الأدوات المساعدة</title>
      ...
      <li class="nav-item active">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class='d-sm-flex align-items-center justify-content-between mb-4'><h1 class='h3 mb-0 text-gray-800'>الأدوات المساعدة</h1><a href='#' class='d-none d-sm-inline-block btn btn-lg btn-primary shadow-sm'data-toggle='modal' data-target='#doctorModal'><i class='fas fa-download fa-sm text-white-50'></i> إضافة أداة جديدة</a></div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">إضافة أداة مساعدة</h4>
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-1">
                        <i class="fas fa-user prefix grey-text"></i>
                        <input type="number" id="count" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="orangeForm-name"> الكمية</label>
                    </div>


                </div>
                <div class="modal-footer d-flex justify-content-center">
                <input type="submit" value="إضافة" class="btn btn-deep-orange">
                </div>
                </form>
            </div>
        </div>
