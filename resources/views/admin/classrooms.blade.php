...
<head>
    ...
    <title> أسم الموقع- القاعات الدراسية</title>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">إضافة قاعة دراسية</h4>
                ...
                <div class="modal-body mx-3">
                    <div class="md-form mb-1">
                        ...
                        <input type="text" id="className" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="orangeForm-name">الأسم</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-user prefix grey-text"></i>
                        <select id="classType" class="form-control validate">
                    ...
                    <div class="md-form mb-1">
                        ...
                        <label data-error="wrong" data-success="right" for="orangeForm-name">السعة</label>
                    </div>
                    <div class="md-form mb-1">
                        <i class="fas fa-user prefix grey-text"></i>
                        <select id="classDatashow" class="form-control validate">
                            <option value="1">نعم</option>
                            <option value="0">لا</option>
                        </select>
                        <label data-error="wrong" data-success="right" for="orangeForm-name">قابلية تركيب جهاز عرض</label>
                    </div>

                </div>
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn btn-deep-orange" id="addingClassroom">إضافة</button>
                </div>
            </div>
        </div>
    </div>
